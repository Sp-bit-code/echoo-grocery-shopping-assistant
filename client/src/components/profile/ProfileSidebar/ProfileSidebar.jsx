      ...
      <div className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-3xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          <div className="relative mb-4">
            <div className="w-20 h-20 rounded-full shadow-lg ring-4 ring-white/60 overflow-hidden">
              {user?.avatar ? (
                <img
                  src={user.avatar}
                  alt={user?.name}
              ...
              <div
                className={`w-full h-full rounded-full bg-gradient-to-br from-gray-600 to-gray-900 items-center justify-center ${
