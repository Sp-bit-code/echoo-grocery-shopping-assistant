  ...
  const handleGoogleLogin =
    async () => {
      ...
      try {
        ...
        /*
          AuthContext handles user login mode
          before starting the Supabase OAuth flow.
        */
        await googleLogin();
      } catch (error) {
        console.error(
  ...
  const handleSubmit =
    async (event) => {
      ...
      try {
        ...
        /*
          Important:
          We do NOT send a role from the frontend.

          Supabase/profile logic assigns every
          normal registration the "user" role.
        */
        ...
        if (hasSession) {
          toast.success(
            `Welcome to EchOo, ${formData.name.trim()}!`
          );
        ...
        /*
          Supabase projects may require email
    ...
    <div className="min-h-screen bg-neutral-200 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-5xl flex flex-col md:flex-row shadow-2xl rounded-[40px] overflow-hidden">
        ...
        <div className="hidden md:flex md:w-1/2 bg-[#1a1a1a] p-12 flex-col justify-between relative overflow-hidden">
          ...
          {/* Original Echoo decorative shape */}
            ...
            >
              ...
              <div className="flex items-start gap-3 py-2">
                <input
                  ...
                  name="terms"
                  type="checkbox"
                  className="h-4 w-4 mt-0.5 accent-black border-gray-300 rounded-md"
                  onChange={
                    handleChange
                  }
                  checked={
